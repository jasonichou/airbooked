...
class Map extends Component {
  ...
  async componentDidMount() {
    const cityUrl = 'http://localhost:3000/api/city/san_francisco_listing'
  ...
  // listingMarkers() {
  //   if (this.state.listings == null || this.state.loading) {
  //     return null
  //   }
  //   return (
  //     <CircleMarker center={[this.state.listings.latitude, this.state.listings.longitude]} radius={5}></CircleMarker>
  //   )
  // }
